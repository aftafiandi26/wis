...
class AnnualEOCLeaveController extends Controller
{
    /**
    ...
    public function create()
    {
        ...
        return view('template_admin.applying_leave.annual-eoc.create', compact(['employee', 'getProvinces', 'user_hod', 'month', 'user_coor', 'user_spv', 'user_pm', 'user_producer']));
    }
