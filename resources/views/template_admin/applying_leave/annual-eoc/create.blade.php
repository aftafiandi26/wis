...
@push('subheadling')
    {{ Breadcrumbs::render('applying-leave.annual.eoc') }}
@endpush
                            ...
                            <div class="col-sm-2 col-md-1">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control @error('balance') is-invalid @enderror"
                                        name="balance" value="{{ $month }}" readonly id="balance">
                            ...
                            <div class="col-sm-2 col-md-1">
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control @error('remains') is-invalid @enderror"
                                        name="remains" value="{{ $month }}" readonly id="remains">
