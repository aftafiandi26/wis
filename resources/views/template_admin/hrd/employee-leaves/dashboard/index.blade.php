...
@endpush
@push('subheadling')
    {{ Breadcrumbs::render('hrd.employee.leave.dashboard') }}
@endpush
                ...
                <div class="card-body">
                    <div class="row align-items-center">
                        ...
                        <div class="col col-stats ms-3 ms-sm-0">
                            <div class="numbers">
                                <p class="card-category">Leave Progress Transaction Form</p>
                                <h4 class="card-title">{{ $leaveTransactions->count() }}</h4>
                                <a href="#" class="card-subtitle float-end text-primary">check detail</a>
                            </div>
                        </div>
                    </div>
                </div>
